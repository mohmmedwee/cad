    ...
    $attributes = $client->getUserAttributes();
        ...
        */
        ...
        if(!empty($user)){
            ...
            //insert data from websevece of facebook
            // Save session attribute user from FB
            $session = Yii::$app->session;
            $session['attributes']=$attributes;

            $user = new User();
            $user->username= $session['attributes']['name'];

            $user->firstname=$session['attributes']['first_name'];
            $user->lastname=$session['attributes']['last_name'];
            $user->email=$session['attributes']['email'];
            $user->img=$session['attributes']['picture'];
            $user->img=$user->img['data']['url'];
            $user->birthday=$session['attributes']['last_name'];
